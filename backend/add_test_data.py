...
users_data = [
    (
        'John', 'Doe', 'john.doe@example.com', generate_password_hash('hashed_password1'), 
    ...
    (
        'Jane', 'Smith', 'jane.smith@example.com', generate_password_hash('hashed_password2'), 
        'MIT', 'Data Science', 2, 
    ...
    (
        'Alice', 'Johnson', 'alice.johnson@example.com', generate_password_hash('hashed_password3'), 
    ...
    (
        'Bob', 'Brown', 'bob.brown@example.com', generate_password_hash('hashed_password4'), 
